...
class Common {
  ...
  static Future<bool> setLocation(Map<String, dynamic> data) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    return prefs.setString('setLocationData', json.encode(data));
  }

  static Future<Map<String, dynamic>> getLocation() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    String info = prefs.getString('setLocationData');
    try {
