...
import 'package:multilocationGroceryApp/screens/checkout/couponList.dart';
import 'package:multilocationGroceryApp/screens/drawer/add-address.dart';
import 'package:multilocationGroceryApp/screens/drawer/drawer.dart';
import 'package:multilocationGroceryApp/screens/drawer/edit-address.dart';
import 'package:multilocationGroceryApp/screens/payment/payment.dart';
...
import 'package:multilocationGroceryApp/service/payment-service.dart';
...
import 'package:multilocationGroceryApp/service/address-service.dart';
...
class _CheckoutState extends State<Checkout> {
  ...
  void _initCall(number) async {
    await canLaunch('tel:$number')
        ? launch('tel:$number')
        : showSnackbar('$number dialing failed');
  }
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        child: GFButton(
                            ...
                            blockButton: true,
                            onPressed: () {
                              _initCall(12334578987);
                              },
                            child: Expanded(
                              child: Text(
                                MyLocalizations.of(context).callForRealTimeDelivery,
                                style: textBarlowRegularBlack(),
                              ),
                            ),
