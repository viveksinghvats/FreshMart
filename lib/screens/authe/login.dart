...
import 'package:multilocationGroceryApp/screens/authe/forgotpassword.dart';
import 'package:multilocationGroceryApp/screens/authe/signup.dart';
...
class _LoginState extends State<Login> {
  ...
  Widget buildEmailTextField() {
    return Padding(
      ...
      child: Container(
        child: TextFormField(
          initialValue: Constants.APP_NAME.contains('Daily Guru')
  ...
  Widget buildPasswordTextField() {
    return Container(
      ...
      child: TextFormField(
        initialValue:
            Constants.APP_NAME.contains('Daily Guru') ? "123456" : null,
        style: textBarlowRegularBlack(),
