...
import 'package:multilocationGroceryApp/screens/checkout/checkout.dart';
      ...
      try {
        ...
        if (onValue['response_code'] == 200 &&
          ...
          if (mounted) {
            setState(() {
              Common.setCartData(null);
              cartCleanMessage = onValue['response_data'];
              cartRemove = true;
              isLoadingCart = false;
            });
          }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: cartRemove == true
                  ...
                  isCartClean
                      ...
                      : GFButton(
                          onPressed: () async {
                            ...
                            await CartService.deleteAllDataFromCart(
                                    cartCleanMessage['cartId'])
                                .then((response) {
                              try {
          ...
          : isGetTokenLoading || isMinAmountCheckLoading
              ? SquareLoader()
              : token == null
                  ? Login(
                      locale: widget.locale,
      ...
      bottomNavigationBar: cartRemove == true
          ? Container(height: 1)
          : isGetTokenLoading || isMinAmountCheckLoading
              ? SquareLoader()
              : token == null
